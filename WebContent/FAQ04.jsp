...
<BODY>
    ...
    <table class="table">
        <thead>
            <tr class="line">
                <td style="background-color: ivory;"><h2><strong>Q.</strong>상품 배송은 얼마나 걸리나요?</h2></td>
            </tr>
        </thead>
        <tbody>
            <tr class="line">
                <td style="font-size: 120%;">
                    ...
                    <p>대부분의 상품은 주말과 공유일을 제외하고 2~3일 정도의 배송일이 소요되며,</p><br>
                    <p>주말이나 공휴일에 주문을 하시게되면 4~5일 정도 소요됩니다.</p><br>
                    <p>감사합니다.</p><br>
                </td>
            </tr>
        </tbody>
