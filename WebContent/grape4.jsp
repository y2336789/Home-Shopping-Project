...
<BODY>
    ...
    <div class="recommend_book">
      <div class="recommend_book__cover">
        <img
          class="img"
          src="./img/fruit/grape.jpg"
          onclick="select()"
          style="width: 600px; height: 600px"
        />
      </div>
      <div class="recommend_book__info">
        <div class="recommend_book__title"><h2>포도 4Kg</h2></div>
        ...
        <div class="line">
          ...
          <span class="fruit_setting2 setting_sweet">13.0 brix 이상</span>
        </div>
        <div class="line">
          <span class="fruit_setting">가격</span>
          <span class="fruit_setting2 setting_sweet">35,000원</span>
        </div>
        <div class="last">
          <div class="buttons">
