...
<BODY>
    ...
    <div class="recommend_book">
      <div class="recommend_book__cover">
        <img
          class="img"
          src="./img/fruit/peach.jpg"
          onclick="select()"
          style="width: 600px; height: 600px"
        />
      </div>
      <div class="recommend_book__info">
        <div class="recommend_book__title"><h2>복숭아 1Kg</h2></div>
        <div class="recommend_book__author">
          	남녀노소 누구나 좋아하는 달콤한 복숭아
        </div>
        <div class="line">
        ...
        <div class="line">
          ...
          <span class="fruit_setting2 setting_sweet">13.1 brix 이상</span>
        </div>
        <div class="line">
          <span class="fruit_setting">가격</span>
          <span class="fruit_setting2 setting_sweet">25,000원</span>
        </div>
        <div class="last">
          <div class="buttons">
