    ...
    <div>
      ...
      <colgroup>
		...
		<thead>
			...
			<tr>
			<% for(int j=0;j<2;j++) {%>
				<td class="textcontent"><a href="./upform.jsp?index=<%=upid[a] %>&tag=up"><%=upName[a] %><br><%=upPrice[a] %>원 </a></td>
				<td class="imgcontent"><a href="./upform.jsp?index=<%=upid[a] %>&tag=up"><img src="<%=upPicture[a] %>" width="320" height="200"/></a></td>
			<%
			a++;
			}%>
			</tr>
