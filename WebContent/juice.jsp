    ...
    <div>
      ...
      <colgroup>
		...
		<thead>
			...
			<tr>
			<% for(int j=0;j<2;j++) {%>
				<td class="textcontent"><a href="./jpform.jsp?index=<%=jpid[a] %>&tag=up"><%=jpName[a] %><br><%=jpPrice[a] %>원 </a></td>
				<td class="imgcontent"><a href="./jpform.jsp?index=<%=jpid[a] %>&tag=up"><img src="<%=jpPicture[a] %>" width="320" height="200"/></a></td>
			<%
			a++;
			}%>
			</tr>
